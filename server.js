...
import resumeV2Router from './routes/resumeV2.js';
import usageStatsRouter from './routes/usageStats.js';
...
app.use('/api/v2/resume', resumeV2Router);
app.use('/api/v2/usage', usageStatsRouter);
